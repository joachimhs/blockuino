...
Blockly.Msg.EEPROM_INCLUDE="Include EEPROM Library";
...
Blockly.Msg.MOTOR_RF_SPEED = "Joystick speed:";
Blockly.Msg.JOYSTICK_X = "X";
Blockly.Msg.JOYSTICK_Y = "Y";
Blockly.Msg.RF_RECEIVER_433_INIT = "Initialize 433MHz library to recieve signal";
Blockly.Msg.RF_SENDER_433_INIT = "Initialize 433MHz library to send signal";
Blockly.Msg.RF_PIN = "RF Pin";
Blockly.Msg.RF_NODE_ID = "RF Node Id";
Blockly.Msg.RF_SENDER_433_SEND = "Send data via radio";
Blockly.Msg.RF_TEXT = "Text";
Blockly.Msg.RF_TALL_1 = "Number 1";
Blockly.Msg.RF_TALL_2 = "Number 2";
Blockly.Msg.RF_RECEIVER_433_TOOLTIP = "Use this block to include the livrary to use the 433 MHz module";
