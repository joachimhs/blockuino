...
Blockly.Msg.ARDUINO_FUNCTION_RETURN_TOOLTIP = "Bruk denne klossen for å returnere en verdi fra en funksjon.";
...
Blockly.Msg.ARDUINO_COMMENT_DEFINE = "Skriv inn en kommentar";
Blockly.Msg.ARDUINO_COMMENT_LABEL = "Kommentar: ";
Blockly.Msg.ARDUINO_COMMENT_TOOLTIP = 'Bruk denne klossen for å lage en kommentar i koden din';
...
Blockly.Msg.ARDUINO_TONE_TOOLTIP = "Bruk denne klossen for å spille av en tone med angitt frekvens. Spiller tonen frem til avslutt tone-klossen";
...
Blockly.Msg.ARDUINO_RANDOM = "Tilfeldig tall";
Blockly.Msg.ARDUINO_RANDOM_FROM = "Fra";
Blockly.Msg.ARDUINO_RANDOM_TO = "Til";
Blockly.Msg.ARDUINO_RANDOM_TOOLTIP = "Bruk denne klossen for å generere et tilfeldig tall innenfor intervallet";
Blockly.Msg.MOTOR_INIT = "Initialiser L293/L298";
Blockly.Msg.MOTOR_INIT_SPEED = "Hastighet (0-255)";
Blockly.Msg.MOTOR_INIT_TOOLTIP = "Bruk denne klossen for å fortelle hvilke porter motorkontrollerens input er koblet til";
Blockly.Msg.MOTOR_SETUP = "L293/L298 Setup";
Blockly.Msg.MOTOR_SETUP_TOOLTIP = "Bruk denne klossen for å sette pinMode til motorkontrollerens tilkoblinger";
Blockly.Msg.MOTOR_STOP = "Stopp";
Blockly.Msg.MOTOR_STOP_TOOLTIP = "Bruk denne klossen for å stoppe bilen";
Blockly.Msg.MOTOR_FORWARDS = "Kjør fremover";
Blockly.Msg.MOTOR_FORWARDS_TOOLTIP = "Bruk denne klossen for å kjøre bilen fremover med maks hastighet";
Blockly.Msg.MOTOR_BACKWARDS = "Kjør bakover";
Blockly.Msg.MOTOR_BACKARDS_TOOLTIP = "Bruk denne klossen for å kjøre bilden bakover med maks hastighet";
Blockly.Msg.MOTOR_ROTATE_RIGHT = "Roter til høyre";
Blockly.Msg.MOTOR_ROTATE_RIGHT_TOOLTIP = "Bruk denne klossen for å rotere bilen mot høyre";
Blockly.Msg.MOTOR_ROTATE_LEFT = "Roter til venstre";
Blockly.Msg.MOTOR_ROTATE_LEFT_TOOLTIP = "Bruk denne klossen for å rotere bilen mot venstre";
Blockly.Msg.MOTOR_SPEED = "Sett bilens hastighet";
Blockly.Msg.MOTOR_SPEED_TOOLTIP = "Bruk denne klossen til å sette hastighetene til venste og høyre side. Verdi fra -255 til 255";
Blockly.Msg.MOTOR_LEFT = "Venstre Side";
Blockly.Msg.MOTOR_RIGHT = "Høyre Side";
Blockly.Msg.ULTRASONIC_INITIALIZE_INIT = "Initialiser Ultrasonisk Sensor";
Blockly.Msg.ULTRASONIC_INITIALIZE_TOOLTIP = "Denne klossen definerer hvilke porter den ultrasoniske sensoren er koblet til";
Blockly.Msg.ULTRASONIC_SETUP = "Ultrasonisk setup";
Blockly.Msg.ULTRASONIC_SETUP_TOOLTIP = "Denne klossen definerer pinMode til den Ultrasoniske sensoren";
Blockly.Msg.ULTRASONIC_DISTANCE = "Les Ultrasonisk Avstand (cm)";
Blockly.Msg.ULTRASONIC_DISTANCE_TOOLTIP = "Denne klossen bruker den ultrasoniske sensoren for å beregne avstand i centimeter";
Blockly.Msg.SERVO_INCLUDE = "inkluder Servo biblitek";
Blockly.Msg.SERVO_INCLUDE_TOOLTIP = "Bruk denne klossen for å hente inn Servo biblioteket";
Blockly.Msg.SERVO_ATTACH = "Koble Servo";
Blockly.Msg.SERVO_ATTACH_TOOLTIP = "Brik denne klossen for å koble servo-variabelen til en Arduino Port";
Blockly.Msg.SERVO_ATTACH_TO_PIN = "Til Port";
Blockly.Msg.SERVO_WRITE = "Skriv Til Servo:";
Blockly.Msg.SERVO_WRITE_TOOLTIP = "Bruk denne klossen til å sette servomotorens vinkel";
Blockly.Msg.OLED_INCLUDE = "Inkluder OLED Biblitotekene";
Blockly.Msg.OLED_INCLUDE_TOOLTIP = "Bruk denne klossen til å inkludere bibliotekene (husk å importere dem til Arduino/libraries). Inkluderer SPI, Wire, Adafruit_GFX og Adafruit_SSD1306.";
Blockly.Msg.OLED_SETUP = "Setup OLED Displayet";
Blockly.Msg.OLED_SETUP_TOOLTIP = "Bruk denne klossen til å inkludere kode som trengs i setup().";
Blockly.Msg.OLED_DRAW_PIXEL = "Tegn Pixel";
Blockly.Msg.OLED_DRAW_PIXEL_TOOLTIP = "Bruk denne klossen til å tegne en enkel pixel";
Blockly.Msg.OLED_SET_CURSOR = "Set Cursor til";
Blockly.Msg.OLED_SET_CURSOR_TOOLTIP = "Bruk denne klossen til å flytte cursor (markøren) til angitt x- og y-koordinat";
Blockly.Msg.OLED_PRINT = "Skriv Tekst:";
Blockly.Msg.OLED_PRINT_TOOLTIP = "Bruk denne klossen til å Skrive teksten der hvor cursor (markøren) står";
Blockly.Msg.OLED_UPDATE_DISPLAY = "Oppdater Display";
Blockly.Msg.OLED_UPDATE_DISPLAY_TOOLTIP = "Bruk denne klossen til å oppdatere displayet (tegne innholdet på nytt)";
Blockly.Msg.OLED_CLEAR_DISPLAY = "Tøm Display";
Blockly.Msg.OLED_CLEAR_DISPLAY_TOOLTIP = "Bruk denne klossen til å fjerne alt som er tegnet på det";
Blockly.Msg.EEPROM_READ= "Les fra EEPROM";
Blockly.Msg.EEPROM_READ_ADDRESS = "Addresse:";
Blockly.Msg.EEPROM_READ_TOOLTIP= "Bruk denne klossen for å lese en verdi fra EEPROM addressen angitt";
Blockly.Msg.EEPROM_LENGTH= "Finn størrelsen på EEPROM";
Blockly.Msg.EEPROM_LENGTH_TOOLTIP= "Bruk denne klossen for å finne størrelsen til EEPROM minnet";
Blockly.Msg.DHT_INIT = "Initialiser DHT biblioteket";
Blockly.Msg.DHT_INIT_PORT = "DHT Port";
Blockly.Msg.DHT_INIT_TOOLTIP = "Bruk denne klossen for å initialisere DHT11 bibltipteket";
Blockly.Msg.DHT_SETUP = "DHT Setup";
Blockly.Msg.DHT_SETUP_TOOLTIP = "Bruk denne klossen i setup for å starte DHT sensoren";
Blockly.Msg.DHT_TEMP = "Les Temperatur";
Blockly.Msg.DHT_TEMP_TOOLTIP = "Bruk denne klossen for å lese temperaturen (float)";
Blockly.Msg.DHT_HUMIDITY = "Les Luftfuktighet";
Blockly.Msg.DHT_HUMIDITY_TOOLTIP = "Bruk denne klossen for å lese luftfuktigheten (float)";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_FUNCTION = "Funksjon som beregner temperatur fra Termistor";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_FUNCTION_TOOLTIP = "Bruk denne klossen for å legge til funksjon for å beregne circa temperatur fra en Termistor";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_TEMP = "Beregn Temperatur fra Termistor";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_TEMP_INVERT = "Inverter Input Verdi";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_TEMP_VALUE = "Analog Input Verdi";
Blockly.Msg.ARDUINO_RAW_THERMISTOR_TEMP_TOOLTIP = "Bruk denne klossen for å beregne circa temperatur fra en Termistor";
Blockly.Msg.ARDUINO_FUNCTION_RETURN_LABEL = "Return";
